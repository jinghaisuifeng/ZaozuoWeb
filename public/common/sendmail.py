...
logger = Log()
# 配置收发件人
recvaddress = ['chen1247619686@163.com','1247619686@qq.com','876158355@qq.com']
# 163的用户名和密码
sendaddr_name = 'chen1247619686@163.com'
sendaddr_pswd = 'chen11'
...
class SendMail:
	...
	def __take_messages(self):
		...
		self.msg['Subject'] = '造作主站WEBUI测试报告'#这里填写测试报告的主题
		...
		att1.add_header('Content-Disposition', 'attachment', filename='jd.htm')
